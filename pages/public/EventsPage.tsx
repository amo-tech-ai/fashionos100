...
export const EventsPage: React.FC = () => {
  ...
  return (
    <div className="bg-white pt-20 min-h-screen font-sans">
      ...
      {/* 1. Hero Section */}
      <section className="relative py-20 md:py-24 overflow-hidden bg-gradient-to-b from-purple-50/40 via-white to-white">
         <div className="container mx-auto px-6 md:px-12 text-center relative z-10">
            <FadeIn>
               <SectionTag>Curated Experiences</SectionTag>
               <h1 className="text-5xl md:text-7xl font-serif font-bold text-fashion-black mb-6 tracking-tight">
               ...
               <div className="max-w-2xl mx-auto relative mb-8">
                  <div className={`flex items-center bg-white rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-2 border transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] ${isAiLoading ? 'border-purple-400 ring-4 ring-purple-50' : 'border-gray-100'}`}>
                     ...
                     <input 
                        ...
                        className="flex-1 p-3.5 outline-none text-sm bg-transparent text-gray-700 placeholder:text-gray-400 font-medium" 
                     />
                     <div className="hidden md:flex items-center gap-2 border-l border-gray-100 pl-4 pr-3 h-8">
                     ...
                     <button 
                        ...
                        className="bg-black text-white p-3.5 rounded-full hover:bg-gray-800 transition-all disabled:bg-gray-400 shadow-md hover:scale-105"
                     >
                        <ArrowRight size={18} />
                     </button>
                  </div>
               ...
               <div className="flex justify-center gap-4">
                  <Button variant="accent" size="sm" className="rounded-full px-6" onClick={resetFilters}>Browse All Events</Button>
                  <Link to="/dashboard/events/new"><Button variant="outline" size="sm" className="rounded-full px-6">Create Event</Button></Link>
               </div>
            </FadeIn>
         </div>
      ...
      {/* 2. Filter Bar - Sticky */}
      <div className="sticky top-[72px] z-40 bg-white/80 backdrop-blur-xl border-b border-gray-100 py-3 transition-all">
         <div className="container mx-auto px-6 md:px-12">
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
               
               {/* Filter Scroll Container */}
               <div className="w-full xl:w-auto overflow-x-auto hide-scrollbar -mx-6 px-6 xl:mx-0 xl:px-0">
               ...
               {/* Right Controls */}
               <div className="flex items-center gap-4 w-full xl:w-auto justify-between xl:justify-end border-t xl:border-t-0 border-gray-100 pt-3 xl:pt-0">
                  <button 
                  ...
                  <span className="text-xs text-gray-400 whitespace-nowrap"><strong className="text-black">{filteredEvents.length}</strong> events found</span>
                  <div className="hidden md:block">
                     <Link to="/dashboard/events/new"><Button variant="accent" size="sm" className="whitespace-nowrap">Start Event Wizard</Button></Link>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-16">
         <div className="container mx-auto px-6 md:px-12">
            <FadeIn>
               ...
               <div className="group relative rounded-[2rem] overflow-hidden aspect-[16/9] md:aspect-[21/9] shadow-xl cursor-pointer hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-3xl text-white">
                     <div className="flex flex-wrap gap-2 mb-6">
                        {FEATURED_EVENT.tags.map(t => (
                           <span key={t} className="bg-white/20 backdrop-blur-md border border-white/20 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">{t}</span>
                        ))}
                     </div>
                     <h3 className="text-3xl md:text-6xl font-serif font-bold mb-6 leading-tight">{FEATURED_EVENT.title}</h3>
                     <p className="text-gray-200 text-lg mb-10 line-clamp-2 md:line-clamp-none max-w-2xl">{FEATURED_EVENT.desc}</p>
                     <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                        <Button variant="white" size="lg" className="px-8">Get Tickets</Button>
                        <div className="flex items-center gap-6 text-sm font-medium text-gray-200">
                           <span className="flex items-center gap-2"><Calendar size={18} /> {FEATURED_EVENT.date}</span>
                           <span className="flex items-center gap-2"><MapPin size={18} /> {FEATURED_EVENT.location}</span>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div className="container mx-auto px-6 md:px-12">
            ...
            <div className="flex gap-6 overflow-x-auto pb-8 -mx-6 px-6 md:mx-0 md:px-0 hide-scrollbar">
               {CATEGORIES.map((cat, i) => (
                  <div key={i} className="min-w-[220px] bg-gray-50 p-8 rounded-[2rem] border border-gray-100 hover:shadow-lg transition-all cursor-pointer group hover:bg-white hover:border-purple-100">
                     <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-6 text-gray-400 shadow-sm group-hover:bg-purple-600 group-hover:text-white transition-colors">
                        <cat.icon size={24} />
                     </div>
      ...
      <section className="py-24 container mx-auto px-6 md:px-12">
         <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-500 text-lg">Everything you need to make the most of your fashion experience.</p>
         </div>
         <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
               ...
               <div key={i} className="p-8 rounded-2xl border border-gray-100 text-center hover:bg-gray-50 hover:shadow-sm transition-all cursor-pointer group">
         ...
         <div className="container mx-auto px-6 md:px-12">
            <div className="flex flex-col md:flex-row items-center gap-20">
               <div className="md:w-1/2">
                  <div className="inline-flex items-center gap-2 bg-purple-500/20 text-purple-300 border border-purple-500/30 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-8">
                     <Sparkles size={12} /> Creator Tools
                  </div>
                  <h2 className="text-4xl md:text-6xl font-serif font-bold mb-6 leading-tight">Want to host your own event?</h2>
                  ...
                  <div className="flex flex-wrap gap-4">
                     <Link to="/dashboard/events/new"><Button variant="white" size="lg">Start Event Wizard</Button></Link>
                     <Button variant="outline" size="lg" className="text-white border-gray-700 hover:bg-white hover:text-black hover:border-white">View Creator Tools</Button>
                  </div>
               </div>
               <div className="md:w-1/2 relative">
                  ...
                  {/* Decorative elements */}
                  <div className="absolute -bottom-8 -left-8 w-32 h-32 border-l-2 border-b-2 border-purple-500/50 -z-10"></div>
                  <div className="absolute -top-8 -right-8 w-32 h-32 border-r-2 border-t-2 border-purple-500/50 -z-10"></div>
               </div>
            </div>
         </div>
      </section>
      ...
      <section className="py-32 bg-white text-center">
         <div className="container mx-auto px-6">
            <FadeIn>
               ...
               <div className="flex justify-center gap-4">
                  <Button variant="primary" size="lg" className="px-10" onClick={resetFilters}>Browse Events</Button>
                  <Link to="/dashboard/events/new"><Button variant="outline" size="lg" className="px-10">Create Event</Button></Link>
               </div>
            </FadeIn>
         </div>
      </section>
