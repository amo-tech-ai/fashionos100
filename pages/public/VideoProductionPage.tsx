  ...
  return (
    <div className="bg-white pt-20 overflow-x-hidden font-sans">
      ...
      <section id="contact" className="py-24 bg-white border-t border-gray-50">
         <div className="container mx-auto px-6 md:px-12">
            <div className="max-w-4xl mx-auto bg-gray-50 rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-lg">
               <div className="text-center mb-12">
                  <SectionTag>Start a Project</SectionTag>
                  <h2 className="text-4xl font-serif font-bold mb-4">Ready to roll?</h2>
                  <p className="text-gray-500">Tell us about your vision. We'll assemble the production crew.</p>
               </div>
               ...
               <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="space-y-2">
                     <label className="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Project Type</label>
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {['Campaign', 'Social Media', 'Event Coverage', 'Lookbook'].map(type => (
                           <label key={type} className="cursor-pointer group">
                              <input type="radio" name="type" className="peer sr-only" />
                              <div className="text-sm font-medium py-3 px-4 bg-white border border-gray-200 rounded-xl text-center peer-checked:border-fashion-purple peer-checked:text-fashion-purple peer-checked:bg-purple-50 transition-all hover:border-gray-300">
                                 {type}
                              </div>
                           </label>
                        ))}
