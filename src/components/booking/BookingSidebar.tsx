...
import { ShoppingBag, Info, HelpCircle, ChevronDown, Save, Camera, User } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden sticky top-24">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="inline-block bg-blue-600 text-white text-[10px] font-bold uppercase tracking-wider px-2 py-1 mb-2">
          Shoot Summary
        </div>
      ...
      <div className="bg-gray-50 p-6 border-t border-gray-100">
         ...
         <div className="space-y-3">
            ...
            {/* Next Step button is handled by main layout usually, but added here for completeness as per prompt */}
